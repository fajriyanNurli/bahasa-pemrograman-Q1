...
"Dheta Amelya Kurniawendy"};
 ...
 String nama = "11410100142";
 int randomnama = new Random().nextInt(daftarNama.length);
 int randomnim = new Random().nextInt(daftarNim.length);
 System.out.println ("nama : " + daftarNama[randomnama] + " NIM : " + daftarNim[randomnim]);
  }
}
